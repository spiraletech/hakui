...
file(GLOB HAKUI_GAMEPLAY_FIREWALL_FILES CONFIGURE_DEPENDS
    "${CMAKE_CURRENT_LIST_DIR}/../src/character/*.hpp"
...
add_library(hakui_gameplay STATIC
    ...
    ${CMAKE_CURRENT_LIST_DIR}/../src/character/CharacterDialogueContent.hpp
...
if(HAKUI_ENABLE_GAMEPLAY_SPECS)
    ...
    add_executable(hakui_character_identity_spec
        ${CMAKE_CURRENT_LIST_DIR}/../tests/hakui/CharacterIdentitySpec.cpp
    )

    add_executable(hakui_character_registry_spec
    ...
    add_executable(hakui_neeshego_render_execution_spec
        ${CMAKE_CURRENT_LIST_DIR}/../tests/hakui/NeeshegoRenderExecutionSpec.cpp
    )

    add_executable(hakui_character_performance_spec
    ...
    add_executable(hakui_character_dialogue_spec
        ${CMAKE_CURRENT_LIST_DIR}/../tests/hakui/CharacterDialogueSpec.cpp
    )
    ...
    target_compile_features(hakui_character_identity_spec PRIVATE cxx_std_20)
    ...
    target_compile_features(hakui_neeshego_render_execution_spec PRIVATE cxx_std_20)
    ...
    target_compile_features(hakui_character_dialogue_spec PRIVATE cxx_std_20)
    target_link_libraries(hakui_character_dialogue_spec PRIVATE hakui_gameplay)
    ...
    if(MSVC)
        ...
        target_compile_options(hakui_character_dialogue_spec PRIVATE /W4 /permissive- /UNDEBUG)
    else()
        ...
        target_compile_options(hakui_character_dialogue_spec PRIVATE -Wall -Wextra -Wpedantic -UNDEBUG)
    endif()
    ...
    if(BUILD_TESTING)
        ...
        add_test(NAME hakui.character_dialogue COMMAND hakui_character_dialogue_spec)
    endif()
endif()
